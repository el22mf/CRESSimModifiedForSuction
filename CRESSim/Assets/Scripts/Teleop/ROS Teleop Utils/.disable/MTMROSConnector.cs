...
public class MTMROSConnector : MonoBehaviour
{
    ...
    public void SetCartesianImpedanceGains(Vector3 posStiff, Vector3 posDamping, Vector3 oriStiff, Vector3 oriDamping)
    {
        ...
        CartesianImpedanceMsg gainsMsg = new CartesianImpedanceMsg
        {
    ...
    void Start()
    {
        ...
        m_rosConnection.Subscribe<OperatingStateMsg>(TOPIC_OPERATING_STATE, OperatingStateCallback);
        ...
        m_rosConnection.RegisterPublisher<CartesianImpedanceMsg>(TOPIC_SET_CARTESIAN_IMPEDANCE_GAINS);
    ...
    private void OperatingStateCallback(OperatingStateMsg msg)
    {
